前面一小节提到了需要了解 web.py 这个文件，这个文件最关键的地方是定义了 Application 和 RequestHandler 类。我们再看看 Tornado 的 Hello World，我们再精简一下，下面是最简单的实例化并启动 [Application](http://www.nowamagic.net/academy/tag/Application) 的方式：
